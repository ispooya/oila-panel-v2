                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text-center">
                                ...
                                @foreach($categories as $cat)
                                    <tr class="us-row-{{$cat->id}}">
                                        <td class="type"><img src="{{$cat->img }}" alt="" width="90"></td>
                                        <td class="type">{{$cat->name}}</td>
                                        <td class="text-center">
                                            <span class="mr-1 "
                                                  data-toggle="tooltip"
                                                  title="حذف">
                                                <a class="update-user"
                                                   href="/product/category/destroy/{{$cat->id}}"
    ...
    <script>
        $(document)
            .on('click', 'form button[type=submit]', function(e) {
                if(!$('#img').val()) {
                    window.alert("لطفا تصویر دسته بندی محصول را وارد کنید.")
